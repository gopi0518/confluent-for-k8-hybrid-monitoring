...
This repo is to deploy a self-managed connect cluster, KSQLDB, Rest Proxy and control center backed confluent cloud and configuring centralized monitoring.
